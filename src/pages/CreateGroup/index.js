...
const CreateGroup =()=>{
    ...
    const handleCreateGroup = (data) => {
        api.post("/groups/", data, { headers: { Authorization: `Bearer ${token}` } })
    ...
    return(
        ...
        <Container onSubmit={handleSubmit(handleCreateGroup)} >
            <NameContainer>
                <TextField variant="outlined" label="Grupo" style={{ width: "68%" }} {...register("name")} ></TextField>
            </NameContainer>
            <DataContainer>
                <TextField variant="standard" label="Descrição" style={{ width: "70%" }} {...register("description")} ></TextField>
